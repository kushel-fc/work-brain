...
**09-24 update:** Slice 3.2 is in review. BDD-3205, BDD-3206 and parent BDD-3223 are all In Review (since 09-22); BDD-3191 (N1 docs) is still In Progress. The product-service stack is two of four merged: [#2753](../archive/prs/product-service.md) (1/4, PCS S3 bucket infra) on 09-22 and [#2754](../archive/prs/product-service.md) (2/4, `@repo/csv-generation` package, a config-driven port of the backend's `columnNames.ts`/`getCsvContent.ts`) on 09-23. [#2767](../prs/mine.md) (3/4, PCS CSV generation module) opened 09-23 and is waiting on human review. Part 4/4 isn't open yet.
