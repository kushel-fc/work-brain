# brand-data-pipeline — archived PRs
...
```
Was in Kushel's to-review queue (approved by dwiajik, him the outstanding reviewer) — merged by abirprantofc without his review.
...
```
Companion/earlier-phase PR to #1734 above.
