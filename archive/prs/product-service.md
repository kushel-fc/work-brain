...
```
Kushel's own PR. Was Approved and ready to merge, but he closed it himself instead: an open question came up ("How should we handle these GTINs") tied to a related Slack discussion from dwiajik — closing to re-visit as a batch later rather than merging as-is.
...
merged: false
closed: 2026-08-27
url: https://github.com/fashioncloud/product-service/pull/2559
```
...
merged: false
closed: 2026-08-27
url: https://github.com/fashioncloud/product-service/pull/2551
```

```yaml
number: 2549
title: update mapping job infra + publish events to stream
author: julsjacinto
state: closed
merged: false
closed: 2026-08-27
url: https://github.com/fashioncloud/product-service/pull/2549
```
...
merged: true
closed: 2026-08-27
url: https://github.com/fashioncloud/product-service/pull/2548
```
...
merged: false
closed: 2026-08-27
url: https://github.com/fashioncloud/product-service/pull/2558
```
Was in Kushel's to-review queue (awaiting-first-review) — closed without his review.
...
merged: true
closed: 2026-08-27
url: https://github.com/fashioncloud/product-service/pull/2543
```
